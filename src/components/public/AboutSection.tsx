    ...
    <section className="py-20 lg:py-28 bg-neu-bg">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          {/* Content */}
          <div>
            <p className="text-body-sm font-semibold uppercase tracking-widest text-cyan-600 mb-3">
              Servicios de Lavandería de {firmName.split(' ')[0]}
            </p>
            <h2 className="font-heading text-display-md md:text-display-lg text-gray-900 mb-6">
              Somos una <span className="text-cyan-600">lavandería moderna</span> en {siteConfig.contact.city}, {siteConfig.contact.country}.
            </h2>
            ...
            <div className="flex items-center gap-4 p-4 bg-neu-bg shadow-neu-inset rounded-2xl">
              ...
              <div>
                ...
                <p className="text-body-sm text-cyan-600">{founderTitle}</p>
              </div>
            </div>

            <Link
              href="/equipo"
              className="inline-flex items-center mt-6 text-cyan-600 hover:text-cyan-700 font-semibold transition-colors"
            >
              Conocer al equipo
