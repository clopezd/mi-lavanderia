...
export function GavelIcon({ className }: IconProps) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
      <path d="M14.5 3L9.5 8M9.5 3l5 5M4 19h16M5 21h14M12 12l-7 7M19 5l-7 7" />
    </svg>
  )
}
...
export function HandshakeIcon({ className }: IconProps) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
      <path d="M20 17l-4-4-3 3-4-4-4 4" />
      <path d="M2 11l4-4 4 4 3-3 4 4 4-4" />
...
// Map value icon names to components
export function ValueIcon({ icon, className }: { icon: string; className?: string }) {
  switch (icon) {
    case 'respect': return <HeartIcon className={className} />
    case 'quality': return <ShieldIcon className={className} />
    case 'team': return <UsersGroupIcon className={className} />
