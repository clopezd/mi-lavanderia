  ...
  return (
    <section className="relative overflow-hidden">
      ...
      <div className="absolute inset-0 bg-gradient-to-br from-cyan-900 via-cyan-800 to-cyan-700">
        ...
        {/* Decorative circles */}
        <div className="absolute -top-20 -right-20 w-96 h-96 bg-cyan-600/20 rounded-full blur-3xl" />
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 md:py-32 lg:py-40">
        <div className="max-w-3xl">
          ...
          <p className="text-body-lg md:text-body-xl text-cyan-100 mb-10 max-w-2xl leading-relaxed">
            {hero.subheadline}
          </p>
