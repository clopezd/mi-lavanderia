...
export function CTABanner() {
  return (
    <section className="relative bg-gradient-to-r from-cyan-800 to-cyan-700 overflow-hidden">
      {/* Decorative */}
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 lg:py-20">
        <div className="flex flex-col lg:flex-row items-center justify-between gap-8">
          <div>
            ...
            <p className="text-body-lg text-cyan-200">
          ...
          <div className="flex flex-col sm:flex-row items-center gap-4 shrink-0">
            <a
              ...
              className="flex items-center gap-3 bg-white text-cyan-800 font-heading font-bold text-display-xs px-8 py-4 rounded-xl hover:bg-cyan-50 transition-colors shadow-lg"
            >
