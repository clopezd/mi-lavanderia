...
export const metadata = {
  title: 'Nuevo Pedido (Admin) | C&C Clean Express'
}
...
export default async function AdminNewAppointmentPage() {
  ...
  return (
    <div className="p-6 md:p-8 max-w-3xl mx-auto">
      <div className="mb-8">
        <h1 className="text-2xl font-bold text-foreground">Nuevo Pedido para Encargado</h1>
        <p className="text-foreground-secondary mt-1">
          Crea un pedido para cualquier encargado de la lavandería
        </p>
      </div>
