...
export function PricingManager({ initialAppointmentTypes, initialLawyers }: PricingManagerProps) {
  ...
  return (
    <div className="space-y-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                ...
                <input
                  ...
                  placeholder="Ej: Servicio de Lavado"
      ...
      {/* Tarifas por Encargado */}
      <section>
        <h2 className="text-lg font-semibold text-foreground mb-4">Tarifas por Encargado</h2>

        <Card className="overflow-hidden">
          <table className="w-full">
            <thead className="bg-gray-50 border-b border-border">
              <tr>
                <th className="text-left px-6 py-4 text-sm font-semibold text-foreground-secondary">Encargado</th>
          ...
          {lawyers.length === 0 && (
            <div className="p-8 text-center">
              <p className="text-foreground-secondary">No hay encargados registrados</p>
            </div>
          )}
        </Card>
      </section>
