    ...
    <div className="space-y-8">
      ...
      <div>
        ...
        <p className="text-foreground-secondary mt-1">
          Métricas de rendimiento de la lavandería
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <Card className="p-6 border-l-4 border-accent-500">
          <div className="flex items-start justify-between">
            <div>
              <p className="text-sm font-medium text-foreground-secondary">Pedidos del Mes</p>
              <p className="text-3xl font-bold text-foreground mt-2">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <Card className="p-6 lg:col-span-2">
          <h3 className="text-lg font-semibold text-foreground mb-4">Rendimiento por Encargado</h3>
          <div className="overflow-x-auto">
            <table className="w-full">
              <thead>
                <tr className="border-b border-border">
                  <th className="text-left py-3 text-sm font-medium text-foreground-secondary">Encargado</th>
                  <th className="text-center py-3 text-sm font-medium text-foreground-secondary">Pedidos</th>
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-warning-700">
                Tienes {formatCurrency(stats.accountsReceivable)} en pedidos completados pendientes de pago.
              </p>
            </div>
          </div>
        </Card>
