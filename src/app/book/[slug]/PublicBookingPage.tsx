      ...
      <div className="bg-primary-500 text-white py-8">
        <div className="max-w-4xl mx-auto px-4">
          <div className="flex items-center gap-2 mb-4">
            ...
            <span className="text-xl font-semibold">C&C Clean Express</span>
          </div>
          <h1 className="text-3xl font-bold">Registra tu Pedido</h1>
        </div>
      </div>
      ...
      <footer className="bg-primary-900 text-white py-8 mt-12">
        <div className="max-w-4xl mx-auto px-4 text-center">
          <div className="flex items-center justify-center gap-2 mb-4">
            ...
            <span className="font-semibold">C&C Clean Express</span>
          </div>
          <p className="text-sm text-white/60">
            Plataforma de gestión de lavandería profesional
          </p>
