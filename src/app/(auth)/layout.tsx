        ...
        <div className="relative z-10 flex flex-col justify-center px-12 xl:px-20">
          <div className="mb-8">
            <div className="flex items-center gap-3 mb-6">
              ...
              <span className="text-2xl font-bold text-white">C&C Clean Express</span>
            </div>
            <h1 className="text-display-md text-white mb-4">
              Gestiona los pedidos de tu lavandería
            </h1>
            <p className="text-lg text-white/70 leading-relaxed">
              La plataforma de gestión diseñada para lavanderías modernas que valoran la organización y la eficiencia.
            </p>
          </div>
