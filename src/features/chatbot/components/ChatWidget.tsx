...
const INITIAL_MESSAGE: Message = {
  id: '1',
  type: 'bot',
  content: 'Hola, soy el asistente virtual de C&C Clean Express. Estoy aquí para ayudarte a registrar un pedido con nuestros encargados.',
  timestamp: new Date(),
  quickReplies: ['Nuevo pedido', 'Ver servicios', 'Horarios de atención']
}
    ...
    <Card className="fixed bottom-6 right-6 w-[380px] h-[600px] flex flex-col shadow-2xl z-50 animate-scale-in overflow-hidden">
      ...
      <div className="bg-primary-500 text-white p-4 flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h3 className="font-semibold">C&C Clean Express</h3>
