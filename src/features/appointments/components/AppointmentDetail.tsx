...
export function AppointmentDetail({ appointment, userRole }: AppointmentDetailProps) {
  ...
  return (
    <div className="space-y-6">
        ...
        <div className="flex items-start justify-between mb-6">
          <div>
            <h2 className="text-xl font-semibold text-foreground mb-1">
              {appointment.appointment_type?.name || 'Servicio de Lavandería'}
            </h2>
        ...
        <div className="grid md:grid-cols-2 gap-6">
          ...
          <div>
            <h3 className="font-medium text-foreground mb-3">
              {userRole === 'client' ? 'Encargado' : 'Cliente'}
            </h3>
      ...
      {userRole === 'lawyer' && (
        <Card className="p-6">
          <h3 className="font-medium text-foreground mb-3">Notas del encargado</h3>
          <textarea
            value={notes}
