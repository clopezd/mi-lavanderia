...
export function UpcomingAppointments({ appointments, userRole }: UpcomingAppointmentsProps) {
  if (appointments.length === 0) {
    return (
      <Card className="p-6">
        <h3 className="font-semibold text-foreground mb-4">Próximos Pedidos</h3>
        <div className="text-center py-8">
          ...
          <p className="text-foreground-secondary">No tienes pedidos próximos</p>
          {userRole === 'client' && (
  ...
  return (
    <Card className="p-6">
      <div className="flex items-center justify-between mb-4">
        <h3 className="font-semibold text-foreground">Próximos Pedidos</h3>
