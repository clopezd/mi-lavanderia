    ...
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        ...
        <StatCard
          ...
          subtitle={`${stats.totalAppointments} pedidos totales`}
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          <Link href="/calendar" className="flex items-center gap-3 p-4 bg-gray-50 rounded-xl hover:bg-gray-100 transition-colors">
            ...
            <div>
              ...
              <p className="text-xs text-foreground-secondary">Ver todos los pedidos</p>
            </div>
          </Link>
          <Link href="/lawyers" className="flex items-center gap-3 p-4 bg-gray-50 rounded-xl hover:bg-gray-100 transition-colors">
            ...
            <div>
              <p className="font-medium text-foreground">Encargados</p>
          ...
          <Link href="/appointments/new/admin" className="flex items-center gap-3 p-4 bg-gray-50 rounded-xl hover:bg-gray-100 transition-colors">
            ...
            <div>
              ...
              <p className="text-xs text-foreground-secondary">Asignar a un encargado</p>
            </div>
          </Link>
          <Link href="/projects" className="flex items-center gap-3 p-4 bg-gray-50 rounded-xl hover:bg-gray-100 transition-colors">
            ...
            <div>
              ...
              <p className="text-xs text-foreground-secondary">Ver pedidos activos</p>
            </div>
          </Link>
        </div>
      </Card>
    ...
    <div className="flex items-center gap-4 p-3 bg-gray-50 rounded-xl">
      ...
      <div className="flex-1 min-w-0">
        ...
        <div className="flex items-center gap-4 text-xs text-foreground-secondary">
          <span>{lawyer.totalAppointments} pedidos</span>
          <span>{lawyer.completedAppointments} completados</span>
      ...
      <div className="flex items-start justify-between gap-2">
        <div className="min-w-0 flex-1">
          ...
          <p className="text-sm text-foreground-secondary">
            con {appointment.lawyer?.profile?.full_name || 'Encargado'}
          </p>
